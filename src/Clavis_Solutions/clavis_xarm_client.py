...
class MoveClient(object):
    def __init__(self):
        ...
        self.ready_0_list = [-0.0506137, 0.7731679, -1.8028949, -0.0069812, 1.0210005, -0.0226889 ]
        self.ready_90_list = [-0.0506137, 0.7731679, -1.8028949, -0.0069812, 1.0210005, -0.0226889 ]
        self.ready_180_list = [-0.0506137, 0.7731679, -1.8028949, -0.0069812, 1.0210005, -0.0226889 ]
        self.ready_270_list = [-0.0506137, 0.7731679, -1.8028949, -0.0069812, 1.0210005, -0.0226889 ]
        #############################################################################################
...
def charging_down_pose():
    ...
    # charging down
    client.move_pose(tar_trans[0],tar_trans[1],tar_trans[2]+0.160,new_rot[0],new_rot[1],new_rot[2],new_rot[3]) # before charging
    client.move_pose(tar_trans[0],tar_trans[1],tar_trans[2]+0.130,new_rot[0],new_rot[1],new_rot[2],new_rot[3]) # charging
